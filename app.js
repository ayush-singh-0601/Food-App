...
ScrollReveal().reveal("..service_card", {
  ...
  ScrollReveal().reveal(".client__content .section_subheader", {
    ...scrollRevealOption,
    delay: 500,
  });
  ScrollReveal().reveal(".client__content .section_header", {
    ...scrollRevealOption,
    delay: 1000,
  });
  ...
  ScrollReveal().reveal(".download__content .section_subheader", {
    ...scrollRevealOption,
    delay: 500,
  });
